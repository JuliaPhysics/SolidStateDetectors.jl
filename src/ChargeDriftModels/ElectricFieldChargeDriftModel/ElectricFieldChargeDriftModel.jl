...
getVe(fv::SVector{3, T}, cdm::ElectricFieldChargeDriftModel, current_pos::CartesianPoint{T}) where {T <: SSDFloat} = -fv
getVh(fv::SVector{3, T}, cdm::ElectricFieldChargeDriftModel, current_pos::CartesianPoint{T}) where {T <: SSDFloat} = fv