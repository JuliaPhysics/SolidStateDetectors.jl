...
export get_active_volume, is_depleted, estimate_depletion_voltage, set_point_type_depletion_handling!, get_full_depletion_depth
export adjust_impurity_and_electric_potential_to_match_depletion!, adjust_bias_and_electric_potential!
