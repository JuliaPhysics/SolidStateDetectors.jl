...
function Adapt.adapt_structure(to, pcs::PotentialCalculationSetup{T, S, 3}) where {T, S}
    PotentialCalculationSetup(
        pcs.grid,
        Adapt.adapt(to, pcs.potential),
        Adapt.adapt(to, pcs.point_types),
        Adapt.adapt(to, pcs.volume_weights),
        Adapt.adapt(to, pcs.q_eff_imp),
        Adapt.adapt(to, pcs.imp_scale),
        Adapt.adapt(to, pcs.q_eff_fix),
        Adapt.adapt(to, pcs.ϵ_r),
        Adapt.adapt(to, pcs.geom_weights),
        Adapt.adapt(to, pcs.sor_const),
        pcs.bias_voltage,
        pcs.maximum_applied_potential,
        pcs.minimum_applied_potential,
        pcs.gauge_ref_potential,
        pcs.boundary_ref_potential,
