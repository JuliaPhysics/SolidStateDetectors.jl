function get_sub_ind_ranges(a::Union{
    ...
    ax1_min_idx = searchsortedfirst(t[1], minimum(ax1)) - 1
    ax2_min_idx = searchsortedfirst(t[2], minimum(ax2)) - 1
    ax3_min_idx = searchsortedfirst(t[3], minimum(ax3)) - 1
    ax1_max_idx = searchsortedfirst(t[1], maximum(ax1)) + 1 
    ax2_max_idx = searchsortedfirst(t[2], maximum(ax2)) + 1 
    ax3_max_idx = searchsortedfirst(t[3], maximum(ax3)) + 1 
