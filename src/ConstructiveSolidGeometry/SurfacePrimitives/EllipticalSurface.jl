...
"""
struct EllipticalSurface{T,TR,TP<:Union{Nothing,T}} <: AbstractPlanarSurfacePrimitive{T}
    r::TR
    φ::TP 
...
function EllipticalSurface(::Nothing,r::TR, φ::TP, origin::PT, rotation::ROT) where {TR, TP, PT, ROT}
...
function EllipticalSurface(;
    ...
    EllipticalSurface(nothing,r, φ, origin, rotation)#First argument is ugly workaround to distinguish promotion function and struct
end
